...
edgeCoin=int(input("Введите сколько у вас монет ребром->   "))
armCoin=int(input("Введите сколько у вас монет гербом->   "))
messange="Минимальное количество монент , которое нужно перевернуть = "
if edgeCoin<armCoin:
    print(f"{messange} {edgeCoin}, чтобы получить все монеты гербом")
elif edgeCoin>armCoin:
    print(f"{messange} {armCoin},чтобы получить все монеты ребром")
else:
    print(f"{messange} {armCoin} в любую сторону")
